...
var downoadLink = "http://a.app.qq.com/o/simple.jsp?pkgname=com.pix72";

/* ---- type.js config ---- */
$('.main-subtitle').typeIt({
     strings: ["全球新鲜干货"],
     speed: 200
});
...
$("[data-toggle=popover]").popover({
        ...
        content: function () {
            if($(window).innerWidth() > 768) {
                return '<div class="qr"><img src="img/iTunes_QR.png" alt="world"></div>';
            } else {
                this.href = downoadLink;
            }
        }
    }
);
...
function showUp() {
    ...
    var a = $(".container-logo").offset().top - $(document).scrollTop() - $(window).height();
    var b = $(".container-logo").height() + $(window).height();

    if(a > 0){
        $(".container-logo").removeClass("showUp");
    } else {
        $(".container-logo").addClass("showUp");
    }
}

$(document).scroll(showUp);
